...
defmodule CurlTest do
  ...
  test "cmd full example" do
    assert Stripe.Curl.cmd( "http://x.com/blah", [ { :u, "abc123" }, { :d, :amount, "1000"}, {:d, :card, "tok_1234"}, {:d, :description, "I love stuff" } ] ) == "curl http://x.com/blah -u abc123: -d amount=1000 -d card=tok_1234 -d \"description=I love stuff\""
  end
